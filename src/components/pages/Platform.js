...
const GenerateHTMLForContent = (props) => {
	return (
		<div className="mt-2">
			<h1 id="platform-header">Platform</h1>
			...
			<h2 id="dpi-header">Deep Packet Inspection (DPI)</h2>
			...
			<h2 id="ids-ips-header">Intrusion Detection and Prevention System (IDS/IPS)</h2>
